...
pdf("Fig_1_Competency_change_with_CI.v2.pdf", width = 6, height = 6)
...
mean_scores_ci %>% filter(Level==1) %>% ggplot(aes(x=Competency,y=Mean_Score,
                           group = Competency, color=Competency)) + 
  geom_point(size =1.8, alpha=.8) + # facet_wrap(~ Competency) + 
  geom_point(data=m2, aes(x=Competency,y=Mean_Score, color=Competency),
             size=1.8, alpha=.8,pch=6)+ 
  geom_point(data=m3, aes(x=Competency,y=Mean_Score, color=Competency),
             size=1.8, alpha=.8,pch=7)+ 
    geom_point(data=m4, aes(x=Competency,y=Mean_Score, color=Competency),
             size=1.8, alpha=.8,pch=8)+ 
